...
namespace MerchantAPI.APIGateway.Domain.Repositories
{
  public interface IFaultTxRepository
  {
    ...
    Task<byte[][]> InsertOrUpdateTxsAsync(DbFaultComponent? faultComponent, IList<Tx> transactions, bool areUnconfirmedAncestors, bool insertTxInputs = true, bool resubmit = false);

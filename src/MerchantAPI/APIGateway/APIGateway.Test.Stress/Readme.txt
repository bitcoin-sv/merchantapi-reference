...
One way is to use docker.internal.host, another way is to use network_mode: host, see https://www.cloudsavvyit.com/14114/how-to-connect-to-localhost-within-a-docker-container/.
...
- mapiConfig:
  ...
  - bitcoindHost: Use if local node is running on different machine (override default "127.0.0.1").
  - bitcoindZmqEndpointIp: Use when you need to override local node's default zmqEndpoint

...
{
  public class FaultTriggerViewModelPost
  {
    [JsonIgnore]
    ...
    public FaultTriggerViewModelPost() { }

    public FaultTriggerViewModelPost(FaultTrigger faultTrigger)
    {
      Id = faultTrigger.Id;
    ...
    public FaultTrigger ToDomainObject()
    {
      return new FaultTrigger
      {
        Id = Id,
        Type = Type,
        DbFaultComponent = DbFaultComponent,
        SimulateSendTxsResponse = SimulateSendTxsResponse,
        Name = Name,
